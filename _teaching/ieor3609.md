...
1. Formulate and solve convex optimization problems.
2. Understand and apply the principles of duality and optimality in convex optimization.
3. Model real-world problems as convex optimization problems and solve them using appropriate software tools.
4. Formulate and solve integer programming problems.
5. Understand the geometric and algorithmic principles underlying integer programming.
6. Implement and solve integer programming models using industry-standard software.
7. Apply advanced optimization techniques to practical problems in various domains.
